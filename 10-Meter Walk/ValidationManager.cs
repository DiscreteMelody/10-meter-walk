...
namespace _10_Meter_Walk
{
    public static class ValidationManager
    {
        ...
        private static string timeFormat = @"^[0-9]{2}:{1}[0-9]{2} {1}[aApP][mM]$";   //times are in hh:mm am/pm format
        private static string timeFormatErrorMessage = "Times should be formatted hh:mm am/pm. 1:40 pm would be 01:40 pm";
